...
export function StarIcon(props: {color: string, style: React.CSSProperties | undefined}) {
    return (
        <svg width="47" height="47" viewBox="0 0 47 47" style={props.style} xmlns="http://www.w3.org/2000/svg">
            <path
