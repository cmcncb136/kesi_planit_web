...
import {ReactComponent as LogoIconSvg} from "./logo_icon.svg";
import {ReactComponent as LogoTitleSvg} from "./logo_title.svg";
...
export function LogoIcon(props) {
    return(
        <SvgIcon
            ...
            inheritViewBox
            sx={props.sx ?? {height: 25, width: 25, p: 0}}
        >
        </SvgIcon>
    )
}
...
export function LogoTitle(props) {
    return (
        ...
        inheritViewBox
        sx={props.sx ?? { height: 25, width: 45, p: 0 }} />
    )
}
